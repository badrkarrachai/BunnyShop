  ...
  return (
    <div className="sm:px-6 flex gap-3 px-4  flex-col mt-8 animate-DownToUp">
        <div className="px-4 flex gap-3 flex-col">
          <div className="sm:text-3xl sm:px-0  text-[1.3rem] font-bold text-[rgb(19,23,39)] dark:text-white">{config.title}</div>
          <p className="text-sm sm:px-0  text-blue-gray-500 dark:text-[#B3B9C4]">{config.discreption}</p>
        </div>
