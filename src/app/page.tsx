    ...
    <div className='w-full flex justify-center items-center'>
      <div className='max-w-[100rem]'>
        ...
        <div className='flex flex-col gap-12'>
          <ProductCard btnVisibile={true} title='Brand new' discreption='Explore more than 10,000 products and assets with the best price.' 
          ...
          <ProductCard btnVisibile={true} title='Popular products' discreption="Explore The most popular products in our platform, Based on the buyer's reviews."
