...
function DetailsCard({title,price,category,description,icon,note,gurantees,productImages}:detailsCardProps){ 
  return(
    ...
    <>
      <div className="flex lg:flex-row flex-col group  items-center w-full  p-4 sm:p-8  gap-6">
        <div className="lg:w-[50%] w-full flex flex-col  lg:items-start items-center  px-4 gap-5 ">
            <div className="text-xl sm:text-3xl  font-semibold sm:font-bold text-center lg:text-left">{title}</div>
            <div className=' flex gap-4'><div className="text-md sm:text-xl font-bold sm:font-semibold">{price}</div> | <div className='text-blue-gray-500'>{category}</div></div>
            <div className="font-medium flex text-center lg:text-left text-blue-gray-500">{description}</div>
            <div className=' flex gap-2'><div className="flex items-center">{icon}</div><div className='text-blue-gray-500'>{note}</div></div>
            ...
            <div className="flex justify-center w-full gap-2"> <div className="flex items-center"><IoShieldOutline/></div> <div className="text-md  font-bold sm:font-semibold flex gap-4 text-blue-gray-500">{gurantees}</div></div>
        </div>
        <div className=" max-h-[450px] w-[50%] h-full ">
          <Carousel
